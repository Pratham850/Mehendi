...
export default function Booking() {
  ...
  return (
    <section id="book" className="py-32 px-6 md:px-12 bg-[#0f0d0b] relative z-10 border-t border-gold/10">
      ...
      <div className="max-w-3xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="group relative">
            ...
            >
              <option value="Bridal" className="bg-[#0f0d0b]">Bridal Canvas</option>
              <option value="Arabic" className="bg-[#0f0d0b]">Arabic Vine</option>
              <option value="Minimal" className="bg-[#0f0d0b]">Minimalist Form</option>
              <option value="Custom" className="bg-[#0f0d0b]">Bespoke Creation</option>
            </select>
          </div>
          ...
          <div className="pt-12 flex flex-col md:flex-row gap-6 justify-center items-center">
            ...
            <button 
              ...
              className="w-full md:w-auto px-12 py-4 bg-gold text-[#0f0d0b] text-xs tracking-widest uppercase font-medium hover:bg-[#e0b472] transition-colors duration-500 rounded-sm flex items-center justify-center gap-3"
            >
