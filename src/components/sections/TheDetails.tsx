...
export default function TheDetails() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-[150vh] bg-[#0a0807] flex items-center justify-center overflow-hidden border-t border-gold/10">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0807] via-transparent to-[#0a0807]" />
      </div>
